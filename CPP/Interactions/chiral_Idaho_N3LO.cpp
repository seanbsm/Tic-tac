...
void chiral_Idaho_N3LO::first_parameter_sampling(bool statement){
}
...
void chiral_Idaho_N3LO::setup_store_matrices(double* p_mesh, int Np, bool coupled, int &S, int &J, int &T, int &Tz){
}

void chiral_Idaho_N3LO::V(int i, int j, double &qi, double &qo, bool coupled, int &S, int &J, int &T, int &Tz, double *Varray){
